...
set(w,'color','#6116ED','linewidth',1.5);
title('eletrodo 2');
xlabel('Numero de pontos');
ylabel('Amplitude (mV)');
grid on;
...
set(w,'color','#ED9816','linewidth',1.5);
title('eletrodo 3');
xlabel('Numero de pontos');
ylabel('Amplitude (mV)');
grid on;
...
set(w,'color','g','linewidth',1.5);
title('eletrodo 4');
xlabel('Numero de pontos');
ylabel('Amplitude (mV)');
grid on;
S  = axes( 'visible', 'off', 'title', 'Frequência 200 kHz - Injeção de corrente de eletrodo 1 para eletrodo 2' );
...
set(w,'color','#ED16A2','linewidth',1.5);
title('eletrodo 5');
xlabel('Numero de pontos');
ylabel('Amplitude (mV)');
grid on;
...
set(w,'color','#EDE316','linewidth',1.5);
title('eletrodo 8');
xlabel('Numero de pontos');
ylabel('Amplitude (mV)');
grid on;
...
S  = axes( 'visible', 'off', 'title', 'Frequência 125 kHz - Injeção de corrente de eletrodo 1 para eletrodo 2' );
hold off;
...
S  = axes( 'visible', 'off', 'title', 'Frequência 100 kHz - Injeção de corrente de eletrodo 1 para eletrodo 2' );
...
S  = axes( 'visible', 'off', 'title', 'Frequência 50 kHz - Injeção de corrente de eletrodo 1 para eletrodo 2' );
